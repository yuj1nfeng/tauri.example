...
export default function ConcatVideos({ list }) {
    ...
    return (
        <ui.Form {...consts.config.formProps} labelCol={{ span: 2, offset: 0 }} wrapperCol={{ span: 4, offset: 0 }}>
            ...
            <ui.Grid.Col span={8} children={<ui.Form.Item label='缩放比例' children={<ui.Input placeholder='缩放比例' />} />}>
            ...
            <ui.Grid.Col span={8} children={<ui.Form.Item label='缩放比例' children={<ui.Input />} />}>
                ...
                <ui.Form.Item label=' 输 出 目 录 ' children={<ui.Input autoWidth={{ minWidth: '180px' }} />} />
            </ui.Grid.Col>
            <ui.Grid.Col span={24}>
