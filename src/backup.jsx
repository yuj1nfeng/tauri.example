...
export default function () {
    ...
    const callRustApi = async () => {
        const result = await tauri.api.core.invoke('convert_video', { input: 'test' });
        await tauri.dialog.message(`调用RUST接口:\n${result}`, { buttons: 'Ok', title: '提示', kind: 'info' });
    };
    ...
    return (
        <div className='video-watermark-remover'>
            ...
            <main className='main-content'>
                ...
                <button className='process-btn' onClick={callRustApi}>
                    <span>调用Rust接口</span>
                </button>
            </main>
